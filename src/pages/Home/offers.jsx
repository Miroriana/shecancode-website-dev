...
const Offers = () => {
  ...
  return (
    <div>
     ...
     <marquee> <p className='application-section-paragraph'>Enroll now for our January cohort in Mobile Application Development Program!&nbsp;&nbsp;&nbsp;&nbsp;<span><a href='/mobiledevelopment'>Apply Here!</a></span> &nbsp;&nbsp;&nbsp;&nbsp;or for our February cohort in Software Engineering program!&nbsp;&nbsp;&nbsp;&nbsp;<span><a href="/softwareCourses">Apply Here!</a></span></p></marquee>
